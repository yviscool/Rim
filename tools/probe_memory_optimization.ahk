...
Sleep(120)
s3 := StatsBall_Sample()
Check("cpu-range", s3.cpu >= 0 && s3.cpu <= 100)
Check("memory-fast", GlobalMemoryStatusFast(&probeTotal, &probeAvail, &probeLoad)
    && probeTotal > 0 && probeAvail > 0 && probeLoad >= 0 && probeLoad <= 100)
